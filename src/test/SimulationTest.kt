...
class SimulationTest {
    ...
    fun `challenge 1`() {
        val matrix = " 7 11 2 2 4 8 2 2\n" +
                ...
                "    3 6 8 9\n" +
                "    4 2 11 3 3"
        Assert.assertEquals(Simulation.createFromString(matrix).run(), 9)
    }

    @Test
    fun `challenge 2`() {
        val matrix = "  12 23 15 2 8 20 21 3 23 3 27 20 0\n" +
        ...
        Assert.assertEquals(Simulation.createFromString(matrix).run(), 16)
    }
